...
public:
	...
	void set_reserved_hours(QDate date, QString h); // employee eneters shifts in which he want to work next week, they are added to callendar and his vector of reserved hours
	void show_calendar();
